...
DB_USER='agterritorio'
DB_USER_PWD='agterritorio123'

# RS has two databases
DATA_INSTANCE='agterritorio'
...
=========='
    ...
    echo 'const DB_NAME = '$DATA_INSTANCE' in application/modules/agenziaterritorio/Bootstrap.php'
    echo '======================================================================
=========='
    echo
}
