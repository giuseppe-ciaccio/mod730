...
class Backend_Model_Dati implements Backend_Model_BackendInterface {

	/**
	 * contains all available scopes for this instance of dataserver
	 * @var array
	 */
//TODO: elenco statico scope deve essere sostituito da
//elenco resource set + scope, tratti da apposito database

	public static $AVAILABLE_SCOPES = array(
		'lettura_dati_anagrafici',
	...
	public function __construct($scopes, $subj) {
		...
		$mapper = new Backend_Mapper_Residente();
