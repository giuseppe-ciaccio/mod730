...
class Comune_Model_ResidenteDecodeException extends Exception {}

class Comune_Model_Residente {	
	/**
	 * codice fiscale
	 * @var string
	 */
	...
	/**
	 * 
	 * @var Comune_Model_NucleoFamiliare
	 */
	 ...
	 * @param Comune_Model_NucleoFamiliare $nucleo_familiare
	 */
...
// 	public function setComuneNascita($comune_nascita) {
// 		$this->comune_nascita = $comune_nascita;
// 		return $this;
// 	}
...
// 	public function setComuneResidenza($comune_residenza) {
// 		$this->comune_residenza = $comune_residenza;
// 		return $this;
// 	}
...
// 	 * @throws Comune_Model_ResidenteDecodeException
...
// 			throw new Comune_Model_ResidenteDecodeException();
...
// 		return new Comune_Model_Residente($cf, $nome, $cognome, $sesso, $data_nascita, 
