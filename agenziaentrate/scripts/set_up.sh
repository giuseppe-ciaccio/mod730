...
DB_USER='agenziaentrate'
DB_USER_PWD='agenziaentrate123'

# RS has two databases
DATA_INSTANCE='agenziaentrate'
...
=========='
    ...
    echo 'const DB_NAME = '$DATA_INSTANCE' in application/modules/agenziaentrate/Bootstrap.php'
    echo '======================================================================
=========='
    echo
}
